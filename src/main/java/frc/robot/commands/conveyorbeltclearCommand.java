...
public class conveyorbeltclearCommand extends CommandBase {
 
        shooterMotorSubsystem m_subsystem;
        ballObstructionSensorSubsystem m_obstructionsubsystem;
        
         
        public conveyorbeltclearCommand(shooterMotorSubsystem motorSubsystem, ballObstructionSensorSubsystem sensorSubsystem) {
        ...
        public boolean isFinished() {
          return m_obstructionsubsystem.isNotObstructed();
        }
    }
