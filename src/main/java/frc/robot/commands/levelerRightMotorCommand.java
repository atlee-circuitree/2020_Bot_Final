...
public class levelerRightMotorCommand extends CommandBase {

  levelerMotorSubsystem m_subsystem;
   
  public levelerRightMotorCommand(levelerMotorSubsystem motorSubsystem) {
